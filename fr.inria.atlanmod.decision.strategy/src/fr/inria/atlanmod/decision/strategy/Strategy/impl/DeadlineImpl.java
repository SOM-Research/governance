 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.decision.strategy.Strategy.impl.DeadlineImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class DeadlineImpl extends EObjectImpl implements Deadline {
	...
	protected EClass eStaticClass() {
		return StrategyPackage.Literals.DEADLINE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StrategyPackage.DEADLINE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StrategyPackage.DEADLINE__NAME:
				return getName();
		}
