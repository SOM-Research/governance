 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.decision.collaboration.Collaboration.impl.TagBasedImpl#getTags <em>Tags</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TagBasedImpl extends MetadataImpl implements TagBased {
	/**
	...
	protected EClass eStaticClass() {
		return CollaborationPackage.Literals.TAG_BASED;
	}
	...
	public EList<Tag> getTags() {
		if (tags == null) {
			tags = new EObjectContainmentEList<Tag>(Tag.class, this, CollaborationPackage.TAG_BASED__TAGS);
		}
		return tags;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case CollaborationPackage.TAG_BASED__TAGS:
