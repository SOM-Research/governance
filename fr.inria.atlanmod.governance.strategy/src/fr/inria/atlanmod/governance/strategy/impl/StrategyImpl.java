 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.governance.strategy.impl.StrategyImpl#getDeadline <em>Deadline</em>}</li>
 *   <li>{@link fr.inria.atlanmod.governance.strategy.impl.StrategyImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link fr.inria.atlanmod.governance.strategy.impl.StrategyImpl#getPeople <em>People</em>}</li>
 *   <li>{@link fr.inria.atlanmod.governance.strategy.impl.StrategyImpl#getName <em>Name</em>}</li>
 *   <li>{@link fr.inria.atlanmod.governance.strategy.impl.StrategyImpl#getAppliedTo <em>Applied To</em>}</li>
 *   <li>{@link fr.inria.atlanmod.governance.strategy.impl.StrategyImpl#getStage <em>Stage</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
