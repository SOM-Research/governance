 ...
 * <ul>
 *   <li>{@link fr.inria.atlanmod.governance.strategy.RatioMajority#getRatio <em>Ratio</em>}</li>
 * </ul>
 * </p>
 *
 * @see fr.inria.atlanmod.governance.strategy.StrategyPackage#getRatioMajority()
 * @model
 * @generated
 */
public interface RatioMajority extends Majority {
	 ...
	 * @see #setRatio(float)
	 * @see fr.inria.atlanmod.governance.strategy.StrategyPackage#getRatioMajority_Ratio()
	 * @model required="true"
	 * @generated
	 */
	float getRatio();
	...
	/**
	 * Sets the value of the '{@link fr.inria.atlanmod.governance.strategy.RatioMajority#getRatio <em>Ratio</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
